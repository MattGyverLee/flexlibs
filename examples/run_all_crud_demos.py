...
def run_single_demo(module_name):
    ...
    try:
        ...
        if hasattr(module, func_name):
            ...
            return {"module": module_name, "operation": operation_name, "status": "SUCCESS", "error": None}
        else:
        ...
        return {"module": module_name, "operation": operation_name, "status": "FAILED", "error": error_msg}
...
def save_report(results, start_time, end_time):
    ...
    with open(report_file, "w", encoding="utf-8") as f:
        ...
        for r in results:
            ...
            status_icon = {"SUCCESS": "[OK]", "FAILED": "[FAIL]", "SKIP": "[SKIP]"}.get(r["status"], "?")
