...
from flexlibs.sync.conflict_resolvers import SourceWinsResolver
from flexlibs.sync.merge_ops import SyncChange
...
class TestSyncEnginePhase2Execution(unittest.TestCase):
    ...
    @patch('flexlibs.sync.merge_ops.MergeOperations')
